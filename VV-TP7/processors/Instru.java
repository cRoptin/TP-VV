...
public class Instru {
    ...
    protected void copyLoggerFile(String tmpDir, String src) throws IOException {
        File dir = new File(System.getProperty("user.dir")+"/src/tes/java/org/apache/commons/math4/processors");
        FileUtils.forceMkdir(dir);
        String packagePath = System.getProperty("user.dir")+"/src/tes/java/org/apache/commons/math4/processors";
        FileUtils.copyFileToDirectory(new File(packagePath + TestWriter.class.getSimpleName() + ".java"), dir);
